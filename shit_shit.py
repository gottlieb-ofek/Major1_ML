...
Security
Insights
Major_HW1_Introduction_ML/prepare.py /
@yoavjavits
yoavjavits final
Latest commit 74fc9ec on May 31
History
1 contributor
467 lines (365 sloc)  18 KB
...
def prepare_data(data, training_data):
    ...
    minmax_normalized_features = ['PCR_01', 'PCR_02', 'PCR_04', 'PCR_06', 'PCR_08', 'PCR_10', 'country', 'longitude',
                                  'latitude', 'num_of_siblings', 'sport_activity', 'PCR_05', 'zip_code']

    standardization_normalized_features = ['weight', 'happiness_score', 'household_income', 'sugar_levels', 'PCR_03',
                                           'PCR_07', 'PCR_09', 'age', 'conversations_per_day']
    ...
    features_list = ['PCR_01', 'PCR_04', 'PCR_05', 'PCR_06', 'PCR_08', 'PCR_10', 'sugar_levels', 'sport_activity',
                     'symptom_shortness_of_breath', 'symptom_sore_throat', 'symptom_cough', 'risk', 'covid', 'spread']
